...
const AddressPage = () => {
  ...
  console.log("current coordinates", coordinates.current);
  ...
  const handleDeleteAddress = (id) => {
    addressData.address.addresses.filter((address) => address.id !== id);
  };
        ...
        {addressData.data.length &&
          addressData.data.map((address) => (
            <AddressCard
              ...
              editButton={handleEditAddress}
              deleteButton={() => handleDeleteAddress(address.id)}
            />
          ))}
      </List>
    </Box>
